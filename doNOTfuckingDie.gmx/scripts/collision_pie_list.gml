/// collision_pie_list(x1,y1,radius, angle1, angle2,obj,prec,notme)
//
//  Returns a list data structure populated with the ids of instances 
//  colliding with a given pie, or noone if no instances found.
//
//      x1,y1       center of the collision pie, real
//      radius      radius of the collision pie, real
//      angle1      angle 
//      angle2      angle
