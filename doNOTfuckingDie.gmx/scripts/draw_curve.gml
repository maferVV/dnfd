/// draw_curve(x1,y1,x2,y2,direction,detail, col, alpha)
//
...
{
    var x1, y1, x2, y2, start_angle, detail, dist, dist_ang, inc, draw_x, draw_y, col, alpha;
    x1 = argument[0];
    y1 = argument[1];
    x2 = argument[2];
    y2 = argument[3];
    ...
    for (i=0; i<1+inc; i+=inc) {
        ...
        draw_vertex_colour(draw_x,draw_y, col, alpha);
    }
    draw_primitive_end();
    return 0;
}
