/// perlin_get_tileset_mask(w, h, tt)
var w = argument0;
var h = argument1;
var tt = real(argument2) - 10; // Variable to check the terrain type nearby. It's Island generator, so it will look for "lower elevated" terrain.
